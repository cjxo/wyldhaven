...
enum {
  ...
  // TODO(christian): THIS STUFF
  //AttributeType_Mana,
  //AttributeType_energy,
  
  
  AttributeType_Count,
};

typedef u8 Player_ClassType;
enum {
  PlayerClassType_Warrior,
  PlayerClassType_Count,
};
...
typedef u64 DragAndDrop_Flags;
enum {
  DragAndDropFlag_Weapon = 0x1,
  DragAndDropFlag_Food = 0x2,
  DragAndDropFlag_Potion = 0x4,
};
