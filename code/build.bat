...
cl %CompilerOpts% %CompilerDefs% /I..\code\ext\freetype ..\code\wyld_main.c user32.lib D3D11.lib d3dcompiler.lib DXGI.lib dxguid.lib freetype.lib Winmm.lib Ole32.lib /link /incremental:no
popd
